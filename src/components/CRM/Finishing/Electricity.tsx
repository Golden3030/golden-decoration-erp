                  ...
                  <div className="p-5 rounded-3xl bg-[#020B1C]/50 border border-[#1f2d4d] flex flex-col justify-between min-h-35 hover:border-[#D4AF37]/30 transition-all">
                    ...
                    <div className="space-y-3 mt-1">
                      ...
                      <div className="flex items-center justify-between text-right">
                        <span className="text-xs text-white font-bold">السعر :</span>
                        <div className="flex items-center justify-between bg-[#020B1C] border border-[#1f2d4d] rounded-xl h-11 px-2 hover:border-[#D4AF37]/50 transition-all select-none w-36" onClick={(e) => e.stopPropagation()}>
                          <button type="button" onClick={() => handleRateChange('rateAcSwitch', (state.accessoriesRates.rateAcSwitch ?? 120) + 5)} className="w-6 h-6 rounded-full bg-[#07132a] text-[#D4AF37] hover:bg-[#D4AF37] hover:text-black font-bold text-xs transition-all cursor-pointer flex items-center justify-center select-none font-sans">+</button>
                      ...
                      <div className="flex items-center justify-between text-right">
                        <span className="text-xs text-white font-bold">الكمية:</span>
                        <div className="flex items-center justify-between bg-[#020B1C] border border-[#1f2d4d] rounded-xl h-11 px-2 hover:border-[#D4AF37]/50 transition-all select-none w-36" onClick={(e) => e.stopPropagation()}>
                          <button type="button" onClick={() => updateStateAndSave(prev => ({ acSwitchCount: prev.acSwitchCount + 1 }))} className="w-6 h-6 rounded-full bg-[#07132a] text-[#D4AF37] hover:bg-[#D4AF37] hover:text-black font-bold text-xs transition-all cursor-pointer flex items-center justify-center select-none font-sans">+</button>
                  ...
                  <div className="p-5 rounded-3xl bg-[#020B1C]/50 border border-[#1f2d4d] flex flex-col justify-between min-h-35 hover:border-[#D4AF37]/30 transition-all">
                    ...
                    <div className="space-y-3 mt-1">
                      ...
                      <div className="flex items-center justify-between text-right">
                        <span className="text-xs text-white font-bold">السعر :</span>
                        <div className="flex items-center justify-between bg-[#020B1C] border border-[#1f2d4d] rounded-xl h-11 px-2 hover:border-[#D4AF37]/50 transition-all select-none w-36" onClick={(e) => e.stopPropagation()}>
                          <button type="button" onClick={() => handleRateChange('rateHeaterSwitch', (state.accessoriesRates.rateHeaterSwitch ?? 120) + 10)} className="w-6 h-6 rounded-full bg-[#07132a] text-[#D4AF37] hover:bg-[#D4AF37] hover:text-black font-bold text-xs transition-all cursor-pointer flex items-center justify-center select-none font-sans">+</button>
                      ...
                      <div className="flex items-center justify-between text-right">
                        <span className="text-xs text-white font-bold">الكمية:</span>
                        <div className="flex items-center justify-between bg-[#020B1C] border border-[#1f2d4d] rounded-xl h-11 px-2 hover:border-[#D4AF37]/50 transition-all select-none w-36" onClick={(e) => e.stopPropagation()}>
                          <button type="button" onClick={() => updateStateAndSave(prev => ({ heaterSwitchCount: prev.heaterSwitchCount + 1 }))} className="w-6 h-6 rounded-full bg-[#07132a] text-[#D4AF37] hover:bg-[#D4AF37] hover:text-black font-bold text-xs transition-all cursor-pointer flex items-center justify-center select-none font-sans">+</button>
                  ...
                  <div className="p-5 rounded-3xl bg-[#020B1C]/50 border border-[#1f2d4d] flex flex-col justify-between min-h-35 hover:border-[#D4AF37]/30 transition-all">
                    ...
                    <div className="space-y-3 mt-1">
                      ...
                      <div className="flex items-center justify-between text-right">
                        <span className="text-xs text-white font-bold">السعر :</span>
                        <div className="flex items-center justify-between bg-[#020B1C] border border-[#1f2d4d] rounded-xl h-11 px-2 hover:border-[#D4AF37]/50 transition-all select-none w-36" onClick={(e) => e.stopPropagation()}>
                          <button type="button" onClick={() => handleRateChange('rateBellSwitch', (state.accessoriesRates.rateBellSwitch ?? 55) + 5)} className="w-6 h-6 rounded-full bg-[#07132a] text-[#D4AF37] hover:bg-[#D4AF37] hover:text-black font-bold text-xs transition-all cursor-pointer flex items-center justify-center select-none font-sans">+</button>
                      ...
                      <div className="flex items-center justify-between text-right">
                        <span className="text-xs text-white font-bold">الكمية:</span>
                        <div className="flex items-center justify-between bg-[#020B1C] border border-[#1f2d4d] rounded-xl h-11 px-2 hover:border-[#D4AF37]/50 transition-all select-none w-36" onClick={(e) => e.stopPropagation()}>
                          <button type="button" onClick={() => updateStateAndSave(prev => ({ bellSwitchCount: prev.bellSwitchCount + 1 }))} className="w-6 h-6 rounded-full bg-[#07132a] text-[#D4AF37] hover:bg-[#D4AF37] hover:text-black font-bold text-xs transition-all cursor-pointer flex items-center justify-center select-none font-sans">+</button>
