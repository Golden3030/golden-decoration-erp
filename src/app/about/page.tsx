...
export default function AboutPage() {
  ...
  return (
    <main className="min-h-screen flex bg-[#020B1C] relative overflow-hidden">
      <Sidebar />
        ...
        <div className="p-8 space-y-6 text-right select-none flex-1 flex flex-col justify-between">
          ...
          <div className="space-y-6">
            <div className="border-b border-[#D4AF37] pb-5">
              <h1 className="text-3xl font-extrabold text-[#D4AF37]">حول نظام Golden Decoration ERP</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-[#07132a] border border-[#D4AF37] rounded-2xl p-6 space-y-4 shadow-xl">
              ...
              <div className="bg-[#07132a] border border-[#D4AF37] rounded-2xl p-6 space-y-4 md:col-span-2 shadow-xl">
          ...
          <div className="bg-[#07132a] border border-[#D4AF37] rounded-2xl p-6 text-center space-y-3 shadow-xl">
